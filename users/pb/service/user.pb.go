...
const file_service_user_proto_rawDesc = "" +
	"\n" +
	"\x12service/user.proto\x12\busers.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xcc\x01\n" +
	"\x04User\x12\x0e\n" +
	...
	"\tpage_size\x18\x04 \x01(\x05R\bpageSize2\xc7\x02\n" +
	"\vUserService\x129\n" +
	"\n" +
...
var file_service_user_proto_depIdxs = []int32{
	...
	3, // 5: users.v1.UserService.UpdateUser:input_type -> users.v1.UpdateUserRequest
	4, // 6: users.v1.UserService.DeleteUser:input_type -> users.v1.DeleteUserRequest
	6, // 7: users.v1.UserService.ListUsers:input_type -> users.v1.ListUsersRequest
	0, // 8: users.v1.UserService.CreateUser:output_type -> users.v1.User
	0, // 9: users.v1.UserService.GetUser:output_type -> users.v1.User
	0, // 10: users.v1.UserService.UpdateUser:output_type -> users.v1.User
	5, // 11: users.v1.UserService.DeleteUser:output_type -> users.v1.DeleteUserResponse
	7, // 12: users.v1.UserService.ListUsers:output_type -> users.v1.ListUsersResponse
